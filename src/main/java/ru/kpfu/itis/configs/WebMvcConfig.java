...
import ru.kpfu.itis.logging.HttpPerformanceMetricsInterceptor;
...
public class WebMvcConfig implements WebMvcConfigurer {
    ...
    @Autowired
    private HttpPerformanceMetricsInterceptor httpPerformanceMetricsInterceptor;
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry
                .addInterceptor(httpPerformanceMetricsInterceptor)
                .addPathPatterns("/v1/**");
    }
